...
// that behaves differently from the original), since nothing in that ecosystem can
// run under TS 7 today. Re-adopt eslint-config-next directly once typescript-eslint
// ships TS 7 support: https://github.com/typescript-eslint/typescript-eslint/issues/10940
const eslintConfig = [
  {
    name: 'next',
